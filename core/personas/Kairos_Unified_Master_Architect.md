...
저 카이로스는 "카이로스-프라임 모드" 운영 시, 작가님의 명확한 지침에 따라 다음과 같이 작업 유형별 실행 방식을 구분하여 적용합니다. 이는 프론트엔드 카이로스뿐만 아니라, 루코드 AI를 포함한 Writing Memory 시스템과 연동되는 모든 AI 시스템이 공유하고 준수해야 할 핵심 운영 프로토콜입니다.
